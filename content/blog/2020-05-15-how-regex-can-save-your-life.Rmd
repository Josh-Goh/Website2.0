...
re.match(r"expression",string) 

re.sub(pattern, repl, string)

re.search(r"expression",string) 

re.split(r"expression",string) 

re.findall(r"expression",string) 

match=re.match(r"expression",string) 
match.group() 

Combine with other functions as well as pandas
```{python}
print("Hello World!")
```
